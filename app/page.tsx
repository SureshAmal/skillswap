    ...
    <main className="min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10">
          Swap skills with fellow students — you teach what you know, learn what
          you need, and earn Time Credits along the way.
        </p>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card className="text-center border-2 border-transparent hover:border-primary/20 transition-colors">
              <CardContent className="pt-8 pb-6 space-y-3">
                ...
                <span className="inline-block text-xs font-bold text-primary bg-primary/10 rounded-full px-2 py-0.5">
                  Step 1
                </span>
                <h3 className="font-bold text-lg">List Your Skills</h3>
                <p className="text-sm text-muted-foreground">
                  Tell us what you can teach (guitar? calculus? cooking?) and
            ...
            <Card className="text-center border-2 border-transparent hover:border-primary/20 transition-colors">
              <CardContent className="pt-8 pb-6 space-y-3">
                ...
                <span className="inline-block text-xs font-bold text-accent bg-accent/10 rounded-full px-2 py-0.5">
                  Step 2
                </span>
                <h3 className="font-bold text-lg">Find Your Match</h3>
                <p className="text-sm text-muted-foreground">
                  Browse peers, find someone who teaches what you need & wants
                  what you know.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-2 border-transparent hover:border-primary/20 transition-colors">
              <CardContent className="pt-8 pb-6 space-y-3">
                ...
                <span
                  className="inline-block text-xs font-bold text-accent-orange rounded-full px-2 py-0.5"
                  style={{ background: "rgba(253,203,110,0.15)" }}
                >
                  Step 3
                </span>
                ...
                <p className="text-sm text-muted-foreground">
                  Meet up (online or IRL), teach each other, and earn Time
        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
          <div className="grid gap-8 md:grid-cols-4 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Teach 1 hour, learn 1 hour — fair and simple
              </p>
            </div>
            <div className="space-y-2">
              <div
              ...
              <p className="text-xs text-muted-foreground">
                Get verified badges for your skills
              </p>
            </div>
            <div className="space-y-2">
              <div
              ...
              <p className="text-xs text-muted-foreground">
                Message your swap partners directly
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-primary text-primary-foreground">
        <div className="max-w-6xl mx-auto px-6 py-16 text-center">
          ...
          <Link
            href="/register"
            className="inline-flex items-center gap-2 bg-white text-primary font-bold rounded-xl px-6 py-3 hover:bg-white/90 transition-colors"
          >
            Create Free Account
