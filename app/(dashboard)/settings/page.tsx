...
export default function SettingsPage() {
  ...
  const [skills, setSkills] = useState<
    { id: string; type: string; level: string; skill: { name: string } }[]
  >([]);
  ...
  const addSkill = async () => {
    ...
    const payload: {
      ...
      type: string;
      level: string;
      certificate?: { title: string; issuer: string; fileUrl: string | null };
    } = {
      name: newSkill.name,
      type: newSkill.type,
    ...
    if (
      ...
      payload.certificate = {
        ...
        fileUrl: newSkill.certFile || null,
      };
    }
  ...
  const changePassword = async () => {
    ...
    if (res.ok) {
      ...
      const data = await res.json();
      setPasswordMsg(data.error || "Error changing password");
    }
    setSaving(false);
        ...
        <div className="space-y-5">
          <FadeIn delay={0.05}>
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>
                  This is what other students see when they find you
                </CardDescription>
              </CardHeader>
              <CardContent className="grid gap-3">
                ...
                <div className="grid gap-1.5">
                  ...
                  <Input
                    ...
                    placeholder="CS major who loves building web apps..."
                  />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="grid gap-1.5">
                    <Label
                      ...
                      className="text-xs flex items-center gap-1"
                    >
                      <BookOpen className="h-3 w-3" /> Major
                    </Label>
                    <Input
                      id="major"
                      value={profile.major}
          ...
          <FadeIn delay={0.2}>
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-base flex items-center gap-2">
                  <Palette className="h-4 w-4" style={{ color: "#e84393" }} />{" "}
                  Appearance
                </CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <FadeIn delay={0.25}>
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                {passwordMsg && (
                  <p
                    className={`text-xs ${passwordMsg.includes("success") ? "text-emerald-500" : "text-red-500"}`}
                  >
                    {passwordMsg}
                  </p>
                )}
                <Button
                  ...
                  disabled={
                    saving || !passwordData.current || !passwordData.new
                  }
                  size="sm"
                  className="w-full"
                >
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-[10px] text-muted-foreground mt-0.5">
                            Showcase your formal expertise to learners
                          </p>
                        </div>
                        <button
                          onClick={() =>
                        ...
                        >
                          <span
                            className={`inline-block h-3 w-3 rounded-full bg-white transition-transform ${newSkill.hasCert ? "translate-x-4" : "translate-x-1"}`}
                          />
                        </button>
                      </div>
                              ...
                              onChange={(e) => {
                                ...
                                if (file) {
                                  ...
                                  reader.onloadend = () => {
                                    setNewSkill({
                                      ...newSkill,
                                      certFile: reader.result as string,
                                    });
                                  };
                                  reader.readAsDataURL(file);
                                  const btn =
                                    document.getElementById("cert-upload-btn");
                                  if (btn) {
