              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className="grid grid-cols-2 gap-2 w-full mt-5">
                  ...
                  <Button
                    ...
                    className="w-full h-9 bg-primary/20 hover:bg-primary/30 text-primary hover:text-primary border-0"
                  >
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <FadeIn delay={0.15}>
            <Card>
              <CardHeader className="pb-4">
                <CardTitle className="text-lg flex items-center gap-2">
                  <Award className="h-5 w-5" style={{ color: "#fdcb6e" }} />{" "}
                  Certificates
                </CardTitle>
          ...
          <FadeIn delay={0.2}>
            <Card>
              <CardHeader className="pb-4">
                <CardTitle className="text-lg flex items-center gap-2">
                  <Star className="h-5 w-5 text-primary" /> Swap with{" "}
                  {user.name.split(" ")[0]}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="rounded-xl bg-muted/50 p-4">
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                      Available credits for learning
                    </p>
                  </div>
                  <div className="rounded-xl bg-muted/50 p-4">
                    <div className="flex items-center gap-2 mb-2">
          ...
          <FadeIn className="w-full max-w-md">
            <Card className="shadow-2xl border-primary/20 max-h-[90vh] overflow-y-auto">
              <CardHeader className="border-b bg-muted/30 pb-4 sticky top-0 bg-card z-10">
                ...
                <CardDescription>
                  Select a skill you want to learn and propose a time.
                </CardDescription>
              </CardHeader>
