...
const USERS = [
  {
    ...
    bio: "Third-year CS student who loves web dev and teaching others. Currently exploring machine learning.",
  ...
  },
  {
    ...
    bio: "Music producer and guitar enthusiast. Also studying business analytics on the side.",
  ...
  },
  {
    ...
    bio: "Design-obsessed UI/UX student. I sketch interfaces for fun and teach Figma workshops.",
  ...
  },
  {
    ...
    bio: "Full-stack developer turned data science nerd. Love helping people debug their code.",
  ...
  },
  {
    ...
    bio: "Fluent in 4 languages. Passionate about linguistics, cultural exchange, and photography.",
  ...
  },
  {
    ...
    bio: "Math tutor by day, chess player by night. Currently working on competitive programming.",
  ...
  },
  {
    ...
    bio: "Environmental science student with a knack for public speaking and debate.",
  ...
  },
  {
    ...
    bio: "Aspiring game developer. I build Unity games and teach C# to beginners.",
  ...
  },
  {
    ...
    bio: "Pre-med student who also writes poetry. Looking to learn digital art and animation.",
  ...
  },
  {
    ...
    bio: "Robotics engineer and Arduino tinkerer. Happy to teach electronics and embedded systems.",
...
async function main() {
  ...
  const certs = [
    ...
    },
    {
      userIdx: 5,
      skill: "Calculus",
      title: "MIT Calculus Certification",
  ...
  const convos = [
    {
      ...
      messages: [
        {
          from: 0,
          text: "Hey Rahul! I saw you want to learn Python. I can help!",
        },
        {
          from: 1,
          text: "That would be great! I've been wanting to learn for a while.",
        },
        {
          from: 0,
          text: "How about we swap? You teach me guitar and I teach you Python?",
        },
        { from: 1, text: "Perfect! When are you free this week?" },
        {
          from: 0,
          text: "I'm free on Tuesday and Thursday evenings. Works for you?",
        },
    ...
    },
    {
      ...
      messages: [
        ...
        {
          from: 3,
          text: "Happy to help! I see you teach Figma — I've been wanting to learn that.",
        },
    ...
    },
    {
      ...
      messages: [
        {
          from: 4,
          text: "Hi Meera! Would you like to practice French conversation?",
        },
        {
          from: 6,
          text: "Oui! That would be amazing. I've always wanted to learn French.",
        },
        {
          from: 4,
          text: "Great! In exchange, could you help me with public speaking tips?",
        },
        {
          from: 6,
          text: "Of course! I do debate coaching too. Let's set up a swap session.",
        },
      ],
    },
    {
      ...
      messages: [
        {
          from: 9,
          text: "Hey Vikram! I noticed you're into game dev. Want to learn Arduino?",
        },
        {
          from: 7,
          text: "Absolutely! I've been thinking about hardware for game controllers.",
        },
        {
          from: 9,
          text: "That's a cool use case. Happy to teach you the basics.",
        },
      ],
    },
  ];
    ...
    for (let i = 0; i < convo.messages.length; i++) {
      ...
      await prisma.message.create({
        data: {
          ...
          createdAt: new Date(
            Date.now() - (convo.messages.length - i) * 3600000,
          ),
        },
      });
      msgCount++;
  ...
  const notifs = [
    {
      ...
      content: "Rahul Mehta wants to swap Guitar for Python",
    },
    { userIdx: 0, type: "MESSAGE", content: "New message from Rahul Mehta" },
    {
      userIdx: 0,
      type: "CERTIFICATE_VERIFIED",
      content: "Your Python certification has been verified!",
    },
    {
      userIdx: 1,
      type: "SESSION_REQUEST",
      content: "Priya Sharma accepted your swap request",
    },
    { userIdx: 2, type: "MESSAGE", content: "New message from Arjun Reddy" },
    {
      userIdx: 3,
      type: "SESSION_REQUEST",
      content: "Ananya Patel wants to swap Figma for TypeScript",
    },
    {
      userIdx: 5,
      type: "CERTIFICATE_VERIFIED",
      content: "Your Calculus certification has been verified!",
    },
    {
      userIdx: 6,
      type: "SESSION_REQUEST",
      content: "Sneha Gupta wants to teach you French",
    },
    {
      userIdx: 7,
      type: "MESSAGE",
      content: "New message from Aditya Joshi about Arduino",
    },
    {
      userIdx: 9,
      type: "SESSION_REQUEST",
      content: "Vikram Singh wants to learn Arduino from you",
    },
  ];
